...
public class SecurityUtils {
    ...
    private static final String[] fonts = {"Chiller", "Mistral", "Stcaiyun"};
    private static final Color[] COLORS = {Color.decode("#7d7461"),
            Color.decode("#88a2a4"), Color.decode("#42f9e7"), Color.decode("#efea4e"),
            Color.decode("#b6a7db"), Color.decode("#bf0d3e"), Color.decode("#34b7ea"),
            Color.decode("#3a7a6d"), Color.decode("#67eaf9"), Color.decode("#f0dc7d")};
